...
public class LogReader
{
    ...
    public static Dictionary<int, List<LogBox>> ReadLogsAsync(string directoryPath, string fileSelectionString)
    {
        ...
        foreach (string log in logFiles)
        {
            ...
            var logParser = new StreamReader(Util.GenerateStreamFromString(log));
