...
public class HololensConnection{
	...
	public void sendDistanceToHololens(DatagramSocket sendSocket, double distance) throws IOException {
		...
		DatagramPacket message = new DatagramPacket(distanceMessage, distanceMessage.length, sendSocket.getLocalAddress(), sendSocket.getLocalPort());
	...
	public void sendCapacity1ToHololens(DatagramSocket sendSocket, double capacity1) throws IOException {
		...
		DatagramPacket message = new DatagramPacket(capacity1Message, capacity1Message.length, sendSocket.getLocalAddress(), sendSocket.getLocalPort());
		sendSocket.send(message);
	}
	...
	public void sendCapacity2ToHololens(DatagramSocket sendSocket, double capacity2) throws IOException {
		...
		DatagramPacket message = new DatagramPacket(capacity2Message, capacity2Message.length, sendSocket.getLocalAddress(), sendSocket.getLocalPort());
		sendSocket.send(message);
	}
